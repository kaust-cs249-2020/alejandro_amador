...
//Reads a one line vector
template<typename T>
vector<T> readVector(string name, T example);

//Reads a vector entry per row
vector<string> readVectorRowString(string name);
